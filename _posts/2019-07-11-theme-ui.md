...
Enough talk, let's see how it's used by creating a little demo app. Feel free to take a look at the [completed demo](http://todo.com) and [source code](http://github.com).
...
The completed demo is viewable [here](https://what.com) and the code can be found in [this repo](https://github.com).
